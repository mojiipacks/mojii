...
export const translations = {
  en: {
    ...
    footer: {
      tagline: 'All samples are 100% royalty-free. Use in commercial projects without additional fees.',
      license: 'License',
    ...
    success: {
      ...
      spamNote: "Didn't receive the email? Check your spam folder or reply to our email for support.",
  ...
  uk: {
    ...
    pack: {
      ...
      disclaimer: 'Всі ціни в USD. Посилання на завантаження надходить на email одразу після оплати.',
    ...
    footer: {
      tagline: 'Всі семпли на 100% royalty-free. Використовуй у комерційних проєктах без додаткових виплат.',
      license: 'Ліцензія',

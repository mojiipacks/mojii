      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-10 text-white/70 leading-relaxed">
          <section>
            ...
            <p>
              By accessing mojii.store or purchasing any product from MOJII, you agree to these
              Terms of Service.
            </p>
          </section>
          <section>
            ...
            <p>
              MOJII sells digital sample packs (WAV audio files) delivered via download link after
              successful payment.
            </p>
          </section>
          <section>
            ...
            <p>
              Payments processed by Creem (USD/EUR cards) and NowPayments (crypto). MOJII does not
          ...
          <section>
            ...
            <p>
              All sales are final once the download link is delivered. Issues? Contact{" "}
          ...
          <section>
            ...
            <p>
              Purchase grants royalty-free license for use in music productions. See our{" "}
              <Link href={`/${lang}/license`} className="text-green-electric hover:opacity-70">
                License Agreement
              </Link>
              .
            </p>
          ...
          <section>
            ...
            <p>
              All content on mojii.store is property of MOJII. No reproduction without permission.
            </p>
          </section>
          <section>
            <h2
